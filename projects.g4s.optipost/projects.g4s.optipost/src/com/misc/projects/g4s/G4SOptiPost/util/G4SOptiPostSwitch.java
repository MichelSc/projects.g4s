 ...
 * @generated
 */
public class G4SOptiPostSwitch<T> extends Switch<T> {
	/**
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case G4SOptiPostPackage.DOMAIN: {
				Domain domain = (Domain)theEObject;
				T result = caseDomain(domain);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case G4SOptiPostPackage.SHIFT: {
				Shift shift = (Shift)theEObject;
				T result = caseShift(shift);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case G4SOptiPostPackage.EMPLOYEE: {
				Employee employee = (Employee)theEObject;
				T result = caseEmployee(employee);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case G4SOptiPostPackage.LOCATION: {
				Location location = (Location)theEObject;
				T result = caseLocation(location);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case G4SOptiPostPackage.SCENARIO: {
				Scenario scenario = (Scenario)theEObject;
				T result = caseScenario(scenario);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case G4SOptiPostPackage.LP_OPTI_POST_FLOW: {
				...
				if (result == null) result = caseRunParams(lpOptiPostFlow);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case G4SOptiPostPackage.LP_ROOT: {
			...
			case G4SOptiPostPackage.LP_JOB: {
				LpJob lpJob = (LpJob)theEObject;
				T result = caseLpJob(lpJob);
				if (result == null) result = caseGeneratorTuple(lpJob);
				if (result == null) result = caseGeneratorElement(lpJob);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case G4SOptiPostPackage.LP_PRECEDENCE: {
				LpPrecedence lpPrecedence = (LpPrecedence)theEObject;
				T result = caseLpPrecedence(lpPrecedence);
				if (result == null) result = caseGeneratorTuple(lpPrecedence);
				if (result == null) result = caseGeneratorElement(lpPrecedence);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Lp Opti Post Flow</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Lp Opti Post Flow</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLpOptiPostFlow(LpOptiPostFlow object) {
		return null;
	}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Lp Job</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Lp Job</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLpJob(LpJob object) {
		return null;
	}

	/**
	 * Returns the result of interpreting the object as an instance of '<em>Lp Precedence</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Lp Precedence</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
