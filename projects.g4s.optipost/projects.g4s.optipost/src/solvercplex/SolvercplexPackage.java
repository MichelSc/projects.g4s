 ...
 * </ul>
 * <!-- end-user-doc -->
 * @see solvercplex.SolvercplexFactory
 * @model kind="package"
 * @generated
 */
public interface SolvercplexPackage extends EPackage {
	 ...
	 * @generated
	 */
	SolvercplexPackage eINSTANCE = solvercplex.impl.SolvercplexPackageImpl.init();

	/**
	 * The meta object id for the '{@link solvercplex.impl.SolverCplexImpl <em>Solver Cplex</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see solvercplex.impl.SolverCplexImpl
	 * @see solvercplex.impl.SolvercplexPackageImpl#getSolverCplex()
	 * @generated
	 */
	int SOLVER_CPLEX = 0;
	...
	/**
	 * Returns the meta object for class '{@link solvercplex.SolverCplex <em>Solver Cplex</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Solver Cplex</em>'.
	 * @see solvercplex.SolverCplex
	 * @generated
	 */
	...
	interface Literals {
		/**
		 * The meta object literal for the '{@link solvercplex.impl.SolverCplexImpl <em>Solver Cplex</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see solvercplex.impl.SolverCplexImpl
		 * @see solvercplex.impl.SolvercplexPackageImpl#getSolverCplex()
