...
/**
 * This is the action bar contributor for the Solvercplex model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class SolvercplexActionBarContributor
	 ...
	 * @generated
	 */
	public SolvercplexActionBarContributor() {
	...
	public void contributeToToolBar(IToolBarManager toolBarManager) {
		toolBarManager.add(new Separator("solvercplex-settings"));
		toolBarManager.add(new Separator("solvercplex-additions"));
	}
	...
	public void contributeToMenu(IMenuManager menuManager) {
		...
		IMenuManager submenuManager = new MenuManager(G4SOptiPostEditorPlugin.INSTANCE.getString("_UI_SolvercplexEditor_menu"), "solvercplexMenuID");
