...
import com.misc.common.moplaf.common.provider.CommonItemProviderAdapterFactory;
...
/**
 * This is an example of a G4SOptiPost model editor.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class G4SOptiPostEditor
	 ...
	 * @generated
	 */
	public static final List<String> FILE_EXTENSION_FILTERS = prefixExtensions(G4SOptiPostModelWizard.FILE_EXTENSIONS, "*.");
			...
			public void partActivated(IWorkbenchPart p) {
				if (p instanceof ContentOutline) {
					if (((ContentOutline)p).getCurrentPage() == contentOutlinePage) {
						getActionBarContributor().setActiveEditor(G4SOptiPostEditor.this);
				...
				else if (p == G4SOptiPostEditor.this) {
					handleActivate();
				}
			}
	...
	protected void handleActivate() {
		...
		if (!removedResources.isEmpty()) {
			if (handleDirtyConflict()) {
				getSite().getPage().closeEditor(G4SOptiPostEditor.this, false);
			}
			else {
		...
		if (!getEditingDomain().getResourceSet().getResources().isEmpty()) {
			...
			//
			{
				ViewerPane viewerPane =
					new ViewerPane(getSite().getPage(), G4SOptiPostEditor.this) {
						@Override
		...
		PropertySheetPage propertySheetPage =
			new ExtendedPropertySheetPage(editingDomain) {
				...
				public void setSelectionToViewer(List<?> selection) {
					G4SOptiPostEditor.this.setSelectionToViewer(selection);
					G4SOptiPostEditor.this.setFocus();
				}
	...
	public void doSaveAs() {
		...
		String[] files = G4SOptiPostEditorAdvisor.openFilePathDialog(getSite().getShell(), SWT.SAVE, filters);
		if (files.length > 0) {
	...
	private static String getString(String key) {
		return G4SOptiPostEditorPlugin.INSTANCE.getString(key);
	}
	...
	private static String getString(String key, Object s1) {
		return G4SOptiPostEditorPlugin.INSTANCE.getString(key, new Object [] { s1 });
	}
